...
<div class="col-lg-4 leftblock">
    ...
    <div style="margin-top:35px;">
        <button class="btn btnvk" style="width:100%" onclick="console.log($('.answerbox>div:first-of-type').parent().parent().find('textarea'));$('.answerbox>div:first-of-type').parent().parent().find('textarea').val($('.answerbox>div:first-of-type').html());alert();$('#actionform').submit();">Сохранить</button>
    
		<button class="btnvkwhite col-lg-12" style="margin-top:20px;" data-toggle="modal" data-target="#myModal">
    ...
    <div class="col-xs-12" style="margin-top:20px;">
		...
		<p style="float: right;width: calc(100% - 37px);color: #24282D;opacity: 0.8;">
			Отправка сообщений с любой рекламой запрещена пунктом 5.13.4 правил ВКонтакте.
		</p>
	</div>
</div>
    ...
    <div class="toggle-button-cover float-right" style="margin-top: -30px;">
              <div class="button-cover">
                <div class="button r" id="button-1">
                  <input type="checkbox" class="checkbox"  onchange="$.get('/bot/action?id=5&action=3&enabled='+(this.value));if($('.enabledaction').html()=='включена')$('.enabledaction').html('выключена');else $('.enabledaction').html('включена');"checked=checked>
                  <div class="knobs"></div>
                  <div class="layer"></div>
                </div>
              </div>
